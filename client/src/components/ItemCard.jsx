...
const ItemCard = ({ description, name, price, offerPrice, images }) => {
  ...
  return (
    <div className="relative bg-white shadow-[7px_5px_20px_1px_rgba(0,_0,_0,_0.1)] rounded-sm py-8 transition-all duration-200 ease-in flex flex-col">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <button className="bg-green-300 rounded-sm hover:bg-green-400 transition-all duration-200 ease-in cursor-pointer px-3 py-1">
